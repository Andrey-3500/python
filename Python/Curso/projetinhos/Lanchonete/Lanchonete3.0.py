# Lista contendo tuplas dos produtos da Lanchonete
produtos = [(100,'Cachorro-Quente',9),
            (101,'Cachorro-Quente Duplo', 11),
            (102,'X-Egg', 12),(103,'X-Salada',13),
            (104,'X-Bacon',14),(105,'X-Tudo', 17),
            (200,'Refrigerante Lata',5),
            (201,'Chá Gelado',4)]

# Cardapio com o Código, nome e valor do produto
print('{:-^51}'.format(' CARDAPIO '))
print('\033[34m{0:<}\033[m|\033[33m{1:^30}\033[m|\033[32m{2:>}\033[m'.format('Código', 'Descrição','Valor(R$)'))
print('-'*50)

# Exposição do produto usando repetição
...
# Repetição para a anotação do pedido
pedido = []
...
while True:
    ...
    while True:
        ...
        try:
            ...
            if tentativa == False:
                print('\033[31m Opção Invalida! código não encontrado!\033[m')
            else:
                break

        except ValueError:
            print('\033[30m-\033[m' * 50)
            print('\033[31m Opção Invalida! Por favor digite o código do produto! \033[m')

#Opção para adição de mais produtos
    opção2 = ' '
...
# Exposição da sacola, mostrando produto, quantidade e valor
